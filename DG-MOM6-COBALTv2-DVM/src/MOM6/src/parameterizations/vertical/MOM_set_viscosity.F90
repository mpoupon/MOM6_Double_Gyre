    ...
    if (use_BBL_EOS .or. CS%body_force_drag .or. .not.CS%linear_drag) then
      ...
      do i=is,ie ; if (do_i(i)) then
        ...
        if (.not.CS%linear_drag .and. (hwtot > 0.0)) then
          ustar(i) = 0.01 ! mpoupon ! cdrag_sqrt_Z*hutot / hwtot
        else
          ustar(i) = 0.01 ! mpoupon ! cdrag_sqrt_Z*CS%drag_bg_vel
        endif
        ...
        do i=is,ie ; ustar(i) = 0.01; enddo ! mpoupon ! cdrag_sqrt_Z*CS%drag_bg_vel ; enddo
